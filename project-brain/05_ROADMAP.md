...
|---|---|---|
| **M0** | Stabilization: ~~rotate overdue secrets~~ (done 2026-07-07), verify RLS on a live instance, ~~resolve `manager`/`barber` role debt~~ (done 2026-07-06, [ADR-003](04_DECISIONS.md)) | — |
...
1. ~~Rotate overdue secrets (critical).~~ Done 2026-07-07 (executed ~2026-06-30) — see [01_CURRENT_STATE.md §10](01_CURRENT_STATE.md).
